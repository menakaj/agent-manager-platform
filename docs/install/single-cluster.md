...
export AMP_CHART_VERSION="v0.1.6"  # Use your desired version
...
```bash
# Set configuration variables
export OBSERVABILITY_CHART_VERSION="v0.1.6"  # Use your desired version
...
```bash
# Set configuration variables
export BUILD_CI_CHART_VERSION="v0.1.6"  # Use your desired version
