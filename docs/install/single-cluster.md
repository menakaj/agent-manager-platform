...
export HELM_CHART_REGISTRY="ghcr.io/agent-mgt-platform"
export AMP_CHART_VERSION="v0.1.3"  # Use your desired version
...
```bash
# Set configuration variables
export OBSERVABILITY_CHART_VERSION="v0.1.3"  # Use your desired version
...
```bash
# Set configuration variables
export BUILD_CI_CHART_VERSION="v0.1.3"  # Use your desired version
...
- Registry: `ghcr.io/agent-mgt-platform`
- Charts:
