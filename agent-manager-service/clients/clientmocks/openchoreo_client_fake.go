...
func (mock *OpenChoreoSvcClientMock) SetupDeployment(ctx context.Context, orgName string, projName string, deploymentPipelineName string, req *spec.CreateAgentRequest) error {
	...
	return mock.SetupDeploymentFunc(ctx, orgName, projName, deploymentPipelineName, req)
}
