import { Box, Typography, alpha, Accordion, AccordionSummary, AccordionDetails, IconButton, Tooltip, TextField, InputAdornment, Collapse, ButtonBase } from "@mui/material";
import { Timeline, ExpandMore, ContentCopy, KeyboardArrowDown } from "@mui/icons-material";
...
export const ExternalAgentOverview = () => {
    ...
    useEffect(() => {
        ...
        try {
            const state = JSON.parse(observeStateStr ?? '{}');
            localStorage.setItem('observeExpanded', JSON.stringify({
                ...state,
        ...
        <Box display="flex" flexDirection="column" gap={3} pt={2}>
            ...
            >
                ...
                >
                    <Box display="flex" gap={2} alignItems="center" flex={1}>
                        ...
                        <Box flex={1}>
                            ...
                            <Typography variant="body2" color="text.secondary" maxWidth="700px">
                                Get complete visibility into your agent&apos;s
                                behavior with distributed tracing,
                ...
                <AccordionDetails sx={{ p: 3, pt: 0 }}>
                    ...
                    {/* Quick Setup Guide */}
                    <Box mb={1} display="flex" flexDirection="column" border="1px solid" borderColor="divider" p={2} borderRadius={2}>
                            ...
                            >
                                <Box>
                                    ...
                                    <Typography variant="caption" color="text.secondary">
                                        ...
                                        CrewAI, AutoGen, and LlamaIndex automatically.
                                    </Typography>
                                </Box>
                            </Box>
                        </Box>
                    </Box>
                    <Box mb={1} display="flex" flexDirection="column" border="1px solid" borderColor="divider" borderRadius={2}>
                        <ButtonBase
                        ...
                        >
                            <Box>
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    OpenTelemetry collector endpoint and authentication credentials
                                    for publishing traces.
                                </Typography>
                            </Box>
                            <KeyboardArrowDown
                                fontSize="small"
                                sx={{
                                    transform: telemetryExpanded ? 'rotate(180deg)' : 'rotate(0deg)',
                                            ...
                                            endAdornment: (
                                                <InputAdornment position="end">
                                                    <Tooltip title={copiedField === 'url' ? 'Copied!' : 'Copy URL'}>
                                                        <IconButton
                                                            onClick={() => handleCopy(instrumentationUrl, 'url')}
                                                            edge="end"
                                                            size="small"
                                                        >
                                ...
                                <TextField
                                    ...
                                    slotProps={{
                                        input: {
                                            ...
                                            endAdornment: (
                                                <InputAdornment position="end">
                                                    <Tooltip title={copiedField === 'apiKey' ? 'Copied!' : 'Copy API Key'}>
                                                        <IconButton
