...
AMP_CHART_VERSION="${AMP_CHART_VERSION:-1.0.0}"
BUILD_CI_CHART_VERSION="${BUILD_CI_CHART_VERSION:-1.0.0}"
OBSERVABILITY_CHART_VERSION="${OBSERVABILITY_CHART_VERSION:-1.0.0}"
