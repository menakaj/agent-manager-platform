...
AMP_CHART_VERSION="${AMP_CHART_VERSION:-v0.1.6}"
BUILD_CI_CHART_VERSION="${BUILD_CI_CHART_VERSION:-v0.1.6}"
OBSERVABILITY_CHART_VERSION="${OBSERVABILITY_CHART_VERSION:-v0.1.6}"
