...
AMP_CHART_VERSION="${AMP_CHART_VERSION:-v0.1.4}"
BUILD_CI_CHART_VERSION="${BUILD_CI_CHART_VERSION:-v0.1.4}"
OBSERVABILITY_CHART_VERSION="${OBSERVABILITY_CHART_VERSION:-v0.1.4}"
